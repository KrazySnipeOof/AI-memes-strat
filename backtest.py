 ...
 * Stops and trails fill at min(trigger, low_weight toward the candle low) plus
   the slip haircuts printed above - NOT at their trigger price. Live fills can
   still be worse (latency, failed transactions, MEV) and the slip percentages
   are calibrated on a handful of paper trials, not a large live sample.
